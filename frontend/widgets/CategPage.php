...
class CategPage extends Widget
{
    public function run($level = 0){
        ...
        echo Html::a('<i class="fa fa-folder-open-o"></i>&nbsp;&nbsp;Все статьи',['/page/page/index'],['style'=>'color:#fff; text-decoration:none; font-size: 0.9em;']);
        echo '</h3>';
        echo '</div>';
        ...
        echo '<i class="fa fa-bars">&nbsp;&nbsp;Статьи </i>';
        echo '</a>';
        echo '</div>';

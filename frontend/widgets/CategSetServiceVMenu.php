...
class CategSetServiceVMenu extends Widget
{
    public function run($level = 0){
        ...
        echo '<h3 style="margin: 0; color: #fff;"><i class="fa fa-thumbs-up"></i>&nbsp;&nbsp;Получение услуг</h3>';
        echo '</div>';
        echo '<div  style="margin: 0px 0px 2px 0px; width: 100%; border: solid 1px #780000;">';
        echo Html::a('Оказание услуг', [Url::to('/service/service/index')], ['class' => 'btn-u btn-u-default', 'style'=>'width:50%; text-align: center; font-size: 11px; text-transform: uppercase; font-weight: 400;']);
        echo Html::a('Получение услуг', [Url::to('/service/set-service/index')], ['class' => 'btn-u btn-u-primary', 'style'=>'width:50%; text-align: center; font-size: 11px; text-transform: uppercase; font-weight: 400;']);
        echo '</div>';
    ...
    private function tree($cat, $level)
    {
        ...
        $path = Url::to('/service/set-service/index');

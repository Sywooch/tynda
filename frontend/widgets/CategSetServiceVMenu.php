...
class CategSetServiceVMenu extends Widget
{
    public function run($level = 0){
        ...
        echo '<h3 style="margin: 0; color: #fff;"><i class="fa fa-thumbs-up"></i>&nbsp;&nbsp;Поиск услуг</h3>';
        echo '</div>';
        ...
        echo Html::a('Поиск услуг', [Url::to('/service/set-service/index')], ['class' => 'btn-u btn-u-primary', 'style'=>'width:50%; text-align: center; font-size: 11px; text-transform: uppercase; font-weight: 400;']);
        echo '</div>';

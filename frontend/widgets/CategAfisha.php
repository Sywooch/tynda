...
class CategAfisha extends Widget
{
    public function run($level = 0){
        ...
        echo Html::a('<i class="fa fa-map"></i>&nbsp;&nbsp;Вся афиша',['/afisha/afisha/index'],['style'=>'color:#fff; text-decoration:none; font-size: 0.9em;']);
        echo '</h3>';
        echo '</div>';
        ...
        echo '<i class="fa fa-bars">&nbsp;&nbsp;Афиша </i>';
        echo '</a>';
        echo '</div>';
    ...
    private function tree($cat, $level)
    {
        ...
        $path = Url::to('/afisha/afisha/index');

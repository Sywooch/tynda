...
<div class="goods-view">
    <div class="form-group">
        <?php if ($user->id === $model['id_user']) { ?>
            <?= Html::a('<i class="fa fa-edit"></i>&nbsp;&nbsp;Редактировать это объявление', [Url::to('/realty/sale/update'), 'id' => $model['id']], ['class' => 'btn btn-primary']) ?>
        <?php } ?>
        <?= Html::a('<i class="fa fa-plus"></i>&nbsp;&nbsp;Подать объявление', [Url::to('/realty/sale/create')], ['class' => 'btn btn-success']) ?>
    </div>

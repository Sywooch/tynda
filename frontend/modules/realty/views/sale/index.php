...
$ses->close();
$this->title = !empty($cur_cat) ? $cur_cat['name'] : 'Объявления о продаже недвижимости';
...
if(!empty($cur_cat)){
    ...
    $m_kw = 'каталог, недвижимость, недвижимость в тынде, продажа недвижимости в тынде, каталог недвижимости в тынде';
    $m_d = 'Каталог объявлений о продаже недвижимости в Тынде';
}

    ...
    <div class="container-fluid">
        <div class="panel panel-default" style="margin-bottom: 5px;">
            <div class="panel-heading" style=" padding: 5px 5px 5px 12px;">
                <h1 class="panel-title" style="display: inline-table; font-size: 1.3em;">Категория:&nbsp;&nbsp;<?= Html::encode($this->title) ?></h1>
                <?= Html::a('<i class="fa fa-plus"></i>&nbsp;&nbsp;Подать объявление', [Url::to('/realty/rent/create')], ['class' => 'btn btn-success pull-right']) ?>
            </div>
            ...
            <?php }/*else{ $category = \common\models\realty\RealtyCat::find()->where(['lvl'=>0, 'active'=>1, 'disabled'=>0, 'visible'=>1])->orderBy('root, lft')->asArray()->all(); ?>
                <div class="panel-body" style=" padding: 5px 12px 12px 12px;">

...
$this->title = 'Мои объявления об аренде недвижимости';
...
<div class="jobs-default-index">
    <div class="panel panel-dark">
        ...
        <div class="panel-body">
            <?= Html::a('Мои объявления о продаже недвижимости', ['/realty/rent/my-ads'], ['class' => 'btn-u btn-u-dark-blue']) ?>
            <?= Html::a('Мои объявления об аренде недвижимости', ['/realty/rent/my-ads'], ['class' => 'btn-u btn-u-default']) ?>
            <br>
            <?= Html::a('<i class="fa fa-plus"></i>  Добавить объявление об аренде недвижимости', ['/realty/rent/create'], ['class' => 'btn-u btn-u-dark', 'style'=>'margin-top: 5px;']) ?>
            <?= LinkPager::widget([
            'pagination' => $pages,
            ]); ?>
            <br><br>
            ...
            <div class="container-fluid s-results margin-bottom-50">
                <?php foreach ($model as $item) { ?>
                    <div class="inner-results">
                        <h3 style="margin:0px;"><?= Html::a($item['name'], ['/realty/rent/view', 'id' => $item['id']], []) ?></h3>
                        <ul class="list-inline">
                            <li>
                                <div class="btn-group" style="margin: 5px 0px;">
                                    ...
                                    echo Html::a('Редактировать',['/realty/rent/update', 'id' => $item['id']], ['class'=>'btn-u btn-u-xs  btn-u-default']);
                                    echo Html::a('Удалить',[Url::home() . '/realty/rent/delete', 'id' => $item['id']], ['class'=>'btn-u btn-u-xs  btn-u-danger','data' => [

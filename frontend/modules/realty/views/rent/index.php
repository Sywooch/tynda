...
if(!empty($cur_cat)){
    ...
    $m_kw = 'каталог, недвижимость, недвижимость в тынде, аренда недвижимости в тынде, каталог аренды недвижимости в тынде';
    $m_d = 'Каталог объявлений об аренде недвижимости в Тынде';
}

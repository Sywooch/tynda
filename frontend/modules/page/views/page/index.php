...
/* @var $searchModel common\models\page\PageSearch */
...
$ses->close();
$this->title = !empty($cur_cat) ? $cur_cat['name'] : 'Статьи';
...
if(!empty($cur_cat)){
    ...
    $m_kw = 'статьи, статьи тынды,информационный портал тынды, все статьи тынды';
    $m_d = 'Информационный порнал Тынды';
}

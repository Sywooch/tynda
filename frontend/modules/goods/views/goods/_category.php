        ...
        <div class="panel panel-default" style="margin-bottom: 5px;">
            <div class="panel-heading" style=" padding: 5px 5px 5px 12px;">
                ...
                <?php// if (!Yii::$app->user->isGuest) { ?>
                    <?= Html::a('<i class="fa fa-plus"></i>&nbsp;&nbsp;Подать объявление', ['create'], ['class' => 'btn btn-success pull-right']) ?>
                <?php //} ?>
            </div>
            ...
            <?php }else{ $category = \common\models\goods\GoodsCat::find()->where(['lvl'=>0, 'active'=>1, 'disabled'=>0, 'visible'=>1])->orderBy('root, lft')->asArray()->all(); ?>
                <div class="panel-body" style=" padding: 5px 12px 12px 12px;">

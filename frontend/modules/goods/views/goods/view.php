...
$this->params['breadcrumbs'][] = ['label' => 'Товары', 'url' => [Url::to('/goods/goods/index')]];
if(!empty($parent_cat)){
    foreach($parent_cat as $cat){
        $this->params['breadcrumbs'][] = ['label' => $cat['name'], 'url' => [Url::to('/goods/goods/index'), 'cat'=>$cat['alias']]];
    }
}
...
<div class="goods-view">
    ...
    <div class="row">
        <div class="col-sm-1">
            <p style="margin-bottom: 0px; margin-top: 8px; font-size: 1.2em; color: #909090;">Товар: </p>
        </div>
        <div class="col-sm-11">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h4 style="margin: 2px;"><i class="small-text" style="font-size: 0.7em;">Категория:</i><?= Html::a(Html::encode($model['category']), [Url::to('/goods/goods/index'), 'cat' => $model['alias']], ['class' => '']) ?></h4>
